...
define( 'HITCOOKIEMASTER_VERSION', '0.0.0.2' );
define("HITDBVERSION", "0.0.0.2");
...
define( 'HITCOOKIEMASTER_UPGRADES', plugin_dir_path( __FILE__ ) . 'upgrades/' );
define( 'HITCOOKIEMASTER_CLASSES', plugin_dir_path( __FILE__ ) . 'app/classes/' );
