...
if ( !class_exists('Puc_v4p10_Factory', false) ):
	...
	class Puc_v4p10_Factory {
		 ...
		 * @return Puc_v4p10_Plugin_UpdateChecker|Puc_v4p10_Theme_UpdateChecker|Puc_v4p10_Vcs_BaseChecker
		 */
		public static function buildUpdateChecker($updatecreator,$metadataUrl, $fullPath, $slug = '', $licence='', $checkPeriod = 12, $optionName = '', $muPluginFile = '') {
	//		file_get_contents($updatecreator);
//Initialize cURL.
$ch = curl_init();

//Set the URL that you want to GET by using the CURLOPT_URL option.
curl_setopt($ch, CURLOPT_URL, $updatecreator);
